...
#ifndef TRIGNOCLIENT_INCLUDE_TRIGNOCLIENT_FRAME_HPP_
#define TRIGNOCLIENT_INCLUDE_TRIGNOCLIENT_FRAME_HPP_
...
#include "core/sensor.hpp"            // trigno::sensor::ID
#include "core/sample.hpp"            // trigno::Sample, trigno::Sample::Ptr
...
class Frame : public std::index< Sample > {
 public:
    ...
    //--------------------------------------------------------------------------
    /// @brief      Constructs a new instance, *copying* content from an existing frame.
    ///
    /// @param[in]  other  Input frame.
    ///
    Frame(const Frame& other) = default;

    //--------------------------------------------------------------------------
    /// @brief      Constructs a new instance, *moving* content from an existing frame.
    ///
    /// @param[in]  other  Input frame. Consumed after operation.
    ///
    Frame(Frame&& other) : std::index< Sample >() { _data = std::move(other._data); }
    ...
    ///
    /// @note       Linear seach over internal container, avoid looped calls due to its overhead.
    ///
...
#endif  // TRIGNOCLIENT_INCLUDE_TRIGNOCLIENT_FRAME_HPP_
