...
#ifndef TRIGNOCLIENT_INCLUDE_TRIGNOCLIENT_SAMPLE_HPP_
#define TRIGNOCLIENT_INCLUDE_TRIGNOCLIENT_SAMPLE_HPP_
...
class Sample {
 public:
    ...
    //--------------------------------------------------------------------------
    /// @brief      Constructs an instance from an existing *copied* instance.
    ///
    Sample(const Sample& other) = default;

    //--------------------------------------------------------------------------
    /// @brief      Constructs an instance from an existing *moved from* instance.
    ///
    Sample(Sample&& other) = default;

    //--------------------------------------------------------------------------
    /// @brief      Assigns sample contents from an existing *copied* instance.
    ///
    Sample& operator=(const Sample& other) = default;

    //--------------------------------------------------------------------------
    /// @brief      Assigns sample contents from an existing *moved from* instance.
    ///
...
#endif  // TRIGNOCLIENT_INCLUDE_TRIGNOCLIENT_SAMPLE_HPP_
