...
int main(int argc, char const *argv[]) {
    ...
    try {
        ...
        // send start trigger & schedule stop 10s from now
        // implementation is compatible with chrono literals, which improves readability and a cleaner syntax.
        std::cout << "Scheduling streaming for 10s..." << std::flush << std::endl;
        auto handle = client.system.start(10s);
        std::cout << "Starting..." << std::flush << std::endl;
        ...
        while (1) {
            ...
            std::cout << idx++ << ": " <<  emg_data.key << std::endl;
        ...
        std::cout << "Streamed stopped w/ '" << error.what() << "'" << std::endl;
        return 3;
    }
