...
#include "network/configuration.hpp"  // trigno::SensorConfiguration
#include "tools/recorder.hpp"         // trigno::network::Recorder
#include "tools/logger.hpp"           // trigno::tools::Logger
#include "tools/exporter.hpp"         // trigno::tools::Exporter
